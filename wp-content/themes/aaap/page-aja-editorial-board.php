<?php
/*
  Template Name: Aja editorial board
 */

$post;
$parent_page_title = empty($post->post_parent) ? get_the_title($post->ID) : get_the_title($post->post_parent);
$page = get_page($post->ID);
$category = get_term_by('slug', 'aja-editorial-board', 'people_jobs');


$custom_posts = get_people_pages_by_category('aja-editorial-board');
...
<div class="page_wrapper">
    <div class="page_content">
        ...
        <div class="page_main_content">
            ...
            <p class="page_text" style="margin-bottom: 0"><?php echo $page->post_content; ?></p>
			<!--<select class="styled">
