<?php
/*
  Template Name: Distinguished Fellows
 */

$post;
$parent_page_title = empty($post->post_parent) ? get_the_title($post->ID) : get_the_title($post->post_parent);
$page = get_page($post->ID);
$category = get_term_by('slug', 'distinguished-fellows', 'people_jobs');


$custom_posts = get_people_pages_by_category('distinguished-fellows');
