<?php
/**
 * Template Name: Advocacy Statements
 */
get_header();
...
//    AND  (($wpdb->posts.post_type='advocacy' AND $wpdb->postmeta.meta_key = 'home_index') OR ($wpdb->posts.post_type = 'post' AND $wpdb->terms.name='News')) 
    ...
    <div class="page_content">
        ...
        <div class="page_main_content policy">
            ...
            <?php foreach ($pageposts as $pagepost): ?>
                <?php
                $linkType = get_post_meta($pagepost->ID, '_advocacy_link_type', true);
                $linkUrl = get_post_meta($pagepost->ID, '_advocacy_link_url', true);
                $pdfURL = get_post_meta($pagepost->ID, '_advocacy_pdf_url', true);
                if ($pagepost->name == 'News') {
                    ...
                    $image = get_post_meta($pagepost->ID, '_advocacy_link_image', true);
                    //$description = get_post_meta($pagepost->ID, '_advocacy_description', true);
                    $description = $pagepost->post_excerpt;
                ...
                <div class="people_info">
                    ...
                    <div class="info">
                        ...
                        <div class="description">
                            ...
                            <a <?php echo $target; ?> href="<?php echo $link; ?>" class="box_link">View Full Advocacy</a>
							<?php endif; ?>
                        </div>
                    </div>
                    <div class="clear"></div>
