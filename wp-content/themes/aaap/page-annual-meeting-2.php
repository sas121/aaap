<?php
/**
 * Template Name: Annual Meeting v2
 */
get_header();
        ...
        <div class="page_main_content main_template">
            ...
            <div class="three_box_holder">
                ...
                <div class="boxes last">
                    ...
                    <a href="<?php echo $rightContentValue['box_link'] ?>" class="blue_button different"><?php echo $rightContentValue['box_link_text'] ?><span>&raquo;</span></a>
