...
{
	global $wpdb;
	add_option('rssslider_height_display_length_s1', "200_2_500");
	add_option('rss_s1', "http://www.wordpress.org/news/feed/");
	add_option('rssslider_height_display_length_s2', "190_2_500");
	add_option('rss_s2', "http://www.wordpress.org/news/feed/");
	add_option('rssslider_height_display_length_s3', "190_3_500");	
